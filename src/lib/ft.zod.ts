...
export const ListProjectsQueryParams = zod.object({
  ...
  "query": zod.string().nullish().describe('Search projects by title or description')
})
...
export const ListUsersQueryParams = zod.object({
  "page": zod.number().nullish().describe('Page number for pagination'),
  "query": zod.string().nullish().describe('Search users by display name or slack ID')
})
