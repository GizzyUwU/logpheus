...
export namespace ZTypes {
  ...
  export const ProjectJournal = zod.object({
    id: zod.number().int(),
    short_brief: zod.string().nullable(),
    long_brief: zod.string().nullable(),
    hours: zod.number().nullable(),
    created_at: zod.string().nullable(),
    archived: zod.boolean().nullable(),
    archived_at: zod.string().nullable(),
    content_language: zod.string().nullable(),
    author_id: zod.uuidv4(),
    author_username: zod.string().nullable(),
    author_slack_id: zod.string().nullable(),
  ...
  export const ProjectResponse = zod.object({
    ...
    description: zod.string().nullable(),
    fruit: zod.string().nullable(),
    level: zod.string().nullable(),
    stage: zod.number().int().nullable(),
  ...
  export const UserProject = zod.object({
    ...
    created_at: zod.string().nullable(),
    updated_at: zod.string().nullable(),
    upvote_count: zod.number().int().nullable(),
    current_user_upvoted: zod.boolean().nullable(),
    has_shipped: zod.boolean().nullable(),
